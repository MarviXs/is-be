...
public class RecipeServiceTests {
    ...
    void testUpdateRecipe() {
        ...
        Command command = new Command("command" + Instant.now().toEpochMilli(), List.of(1.0,2.0,3.0), DeviceTypeEnum.SDG_CUBE, false);
        commandService.createCommand(command);
    ...
    void removeCommandFromRecipeTest() {
        ...
        Command command1 = new Command("command1" + Instant.now().toEpochMilli(), List.of(1.0,2.0,3.0), DeviceTypeEnum.ESP32, false);
